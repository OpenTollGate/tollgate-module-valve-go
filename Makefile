...
GO_PKG:=https://github.com/OpenTollGate/tollgate-module-valve-go.git
...
define Package/$(PKG_NAME)/description
	TollGate Valve Module for OpenWrt
endef
...
define Package/$(PKG_NAME)/install
	...
	$(INSTALL_BIN) $(GO_PKG_BUILD_BIN_DIR)/tollgate-valve $(1)/usr/bin/tollgate-valve
endef
